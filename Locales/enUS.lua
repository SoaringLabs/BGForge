...
local c1 = ns.c1
L["今日"] = "Today"
L["今日任务"] = "Today's tasks"
L["每日任务"] = "Daily tasks"
L["项待完成"] = "items to do"
L["团队副本"] = "Raids"
L["已有进度"] = "In progress"
L["尚未开始"] = "Not started"
L["资源与快捷入口"] = "Resources & shortcuts"
L["物品详情"] = "Item details"
L["剩余格数"] = "Free slots"
L["种物品"] = "item types"
L["查看进度"] = "View progress"
L["本周获取"] = "Earned this week"
L["没有匹配的物品"] = "No matching items"
L["搜索背包物品"] = "Search bag items"
L["查看"] = "View"
L["待完成"] = "To do"
L["周常任务"] = "Weekly tasks"
L["每周重置"] = "Weekly reset"
L["团队副本进度"] = "Raid progress"
L["本周尚无首领击杀"] = "No bosses defeated this week"
L["快速查看"] = "Quick look"
L["查看装备"] = "View gear"
L["查看背包"] = "View bags"
L["每日事项已完成"] = "Daily tasks complete"
L["数据快照"] = "Snapshot"
...
do
    ...
    L["BGForge插件提醒：由于暴雪对插件UI数量的限制，本插件无法在硬核服务器使用，请你自行禁用。"] = "BGForge Addon Reminder: Due to Blizzard's UI limit for addons, this addon cannot be used on Hardcore servers. Please disable it manually."
    L["检测到 %s 与 BGForge 同时启用。它们会争用相同的全局变量、界面对象和存档变量，可能导致界面错乱、功能失效或账本数据混乱。建议禁用冲突插件并立即重载界面。"] = "Detected %s running together with BGForge. These addons compete for the same global variables, UI objects, and saved variables, which may cause broken interfaces, failed features, or corrupted ledger data. Disable the conflicting addons and reload the UI now."
    L["暂时禁用 %s 并重载"] = "Temporarily Disable %s and Reload"
    L["暂时禁用冲突插件并重载"] = "Temporarily Disable Conflicts and Reload"
    L["暂不处理"] = "Not Now"
    ...
    L["也有可能是你的WCL插件缺少本服务器数据包。鼠标指向一个玩家时，如果不显示WCL数据，说明就是上述问题。此问题与BGForge插件无关。"] = "It may also be that your WCL addon lacks data files for this server. If no WCL data shows when hovering over players, that is the cause. This issue has nothing to do with BGForge."
    L["保存"] = "Save"
    L["分享"] = "Share"
    L["导出"] = "Export"
    L["应用"] = "Apply"
    ...
    L["BGForge历史价格"] = "BGForge Historical Price"
    L["读取中"] = "Loading"
    L["%s-%s"] = "%s-%s"
    L["（占比%s%%）"] = "(Percentage: %s%%)"
    ...
    L["BGForge插件大量使用输入框，该选项可以修改其字体大小。"] = "The BGForge AddOn uses numerous input boxes; this option allows you to modify their font size."
    ...
    L["未知橙片数量|cffFFD100（该玩家可能未安装BGForge插件，或者BGForge插件版本太低）|r"] = "Unknown number of orange slices |cffFFD100 (this player may not have the BGForge plugin installed, or the BGForge plugin version is too low) |r"
    ...
    L["确认重置BGForge插件的所有配置文件？包括心愿清单、历史表格、角色总览、设置选项等等全部都会被重置。"] = "Confirmed to reset all configuration files of BGForge plugin? This includes Wish Lists, History Tables, Character Overview, Settings Options, etc. All will be reset."
    ...
    L["BGForge正在申请确认交易"] = "BGForge is requesting a trade confirmation"
    ...
    L["<BGForge> 已自动清空表格< %s >，分钱人数已改为%s人。"] = "<BGForge> has automatically cleared the table < %s > and the number of people splitting money has been changed to %s of people."
    L['当前副本所在的表格BOSS编号（%s-%s）格子中存在旧记录。'] = "Old records exist in Boss rows %s-%s for the current raid."
    L['自动清空表格的原因：1.当前副本你是新CD；2.%s'] = "Automatic clear reason: 1. This is a new lockout; 2. %s"
    L["你的BGForge插件存在问题，请删除本地插件再重新安装一次（需要大退）。"] = "There is a problem with your BGForge plugin, please delete the local plugin and reinstall it again (requires a major regression)."
    ...
    L["交流群"] = "QQGroup"
    L["BGForge插件未来的更新计划共享在在线文档。"] = "BGForge plugin's future update plan is shared in an online document."
    ...
    L["你可在插件设置-BGForge-其他功能-查询记录里关闭这个功能。"] = "You can rf this function in Plugin Settings - BGForge - Other Functions - Query Records."
    L["关闭名单"] = "rf list"
    ...
    L["你可以在这里更新BGForge插件。"] = "You can update BGForge plugins here."
    ...
    L["需要你在后台已打开网易DD，否则进入失败。\n\n|cff808080你可在插件設置-BGForge-其他功能-密語模板裡關閉這個功能。|r"] = "Requires you to have opened Netflix DD in the background, otherwise entry fails. \n\n|cff808080You can turn off this function in Plugin Settings-BGForge-Other Functions-Secret Message Template. |r"
    L["罚款"] = "Fine"
    ...
    L["把对方账单的金额覆盖我当前表格的金额。如果对方是BGForge插件的账单，则也会复制其买家。"] = "Overwrite the amount of the other party's bill with the amount of my current form. If the other party is billed by the BGForge plugin, it will also copy its buyer."
    ...
    L["删除该名玩家在BGForge插件里的全部举报记录。\n\n|cff808080你可在插件设置-BGForge-其他功能里关闭这个功能。|r"] = "Delete all report records of this player in BGForge plugin. \n\n|cff808080 You can rf this function in Plugin Settings - BGForge - Other Functions. |r"
    L["遭劫货物"] = "Looted Goods"
    ...
    L["你可在插件设置-BGForge-其他功能里关闭这个功能。"] = "You can rf this function in Plugin Settings - BGForge - Other Functions."
    L["查询记录"] = "Query Records"
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00BFFF关注|r和|cff00FF00心愿|r。"] = "|cff00BFFF<BGForge>|r has automatically canceled %s of |cff00BFFF Follows|r and |cff00FF00 Wishes|r."
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00BFFF关注|r。"] = "|cff00BFFF<BGForge>|r has automatically canceled %s of |cff00BFFF concerns|r."
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00FF00心愿|r。"] = "|cff00BFFF<BGForge>|r has automatically canceled %s of |cff00FF00 Wish|r."
    L["全阶段"] = "Full Stage"
    ...
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n快捷命令：/BGReport\n\n|cff808080你可在插件设置-BGForge-其他功能里关闭这个功能。|r"] = "Choose the reason for reporting: %s\nSelect the item to report: %s\nFill in the details of the report: %s\n\nShortcut to 'Enchant Bracer - Superior Strength' : /BGReport\n\n|cff80808080You can rf this function in Plugin Settings - BGForge - Other Functions. |r"
    L["一键举报RMT"] = "One Click Report RMT"
    L["选择举报理由：%s\n选择举报项目：%s\n填写举报细节：%s\n\n|cff808080你可在插件设置-BGForge-其他功能里关闭这个功能。|r"] = "Select Report Reason: %s\nSelect Report Item: %s\nFill in Report Details: %s\n\n|cff80808080You can rf this function in Plugin Settings-BGForge-Other Functions. |r"
    ...
    L["集结号增强|cff808080（该功能由BGForge插件提供）|r"] = "Rally Enhancement|cff808080 (This feature is powered by BGForge plugin)|r"
    ...
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGForge插件并且版本在1.7.0或以上，可以不用安装该WA。"] = "|cffFFFFFFInstalled WA:|rThis WA is the member's side, it is used to receive the auction message from the leader, the members who don't have it installed won't be able to show the auction UI. please ask the leader to install this WA string and send it to the members to install. If you have installed BGForge plugin and version is 1.7.0 or above, you don't need to install this WA."
    ...
    L["你可在插件设置-BGForge-其他功能里关闭这个功能"] = "You can rf this function in the plugin settings - BGForge - Other Functions."
    ...
    L["对账"] = "Reconciliation"
    L["< 对账 >"] = "< Reconciliation >"
    L["当团队有人通报BGForge/RaidLedger/大脚的账单，你可以选择该账单，来对账"] = "When someone on your team reports a BGForge/RaidLedger/Bigfoot bill, you can select that bill to reconcile it."
    ...
    L["如果你想关闭该功能，可在插件设置-BGForge-角色总览里关闭"] = "If you want to rf this feature, you can rf it in the plugin settings - BGForge - Character Overview."
    ...
    L["1、对BGForgeYY频道的在线玩家发出该YY的请求"] = "1、Send a request for this YY to the online players of BGForgeYY channel"
    ...
    L["< BGForge > 你的当前版本%s已过期，请更新插件。"] = "< BGForge > Your current version of %s has expired, please update the plugin."
    ...
    L["< BGForge > 金 团 表 格"] = "< BGForge > Gold Group Forms"
    ...
    L["历史表格保留时长"] = "History retention"
    L["当前表格为空，未保存历史记录。"] = "The current ledger is empty; no history record was saved."
    L["历史表格保存失败。"] = "Failed to save the history record."
    L["已保存至历史表格，当前表格不会被清空。"] = "Saved to local history. The current ledger was not cleared."
    ...
    L["<UI缩放>"] = "<UI Zoom"
    L["<UI透明度>"] = "< UI Transparency"
    L["< BGForge > 版本过期提醒，最新版本是：%s，你的当前版本是：%s"] = "< BGForge > version expiration reminder, the latest version is: %s, your current version is: %s"
    L["星星"] = "Stars"
    L["BGForge金团表格"] = "BGForge Gold Corps Forms"
...
do
    ...
    L["已暂停"] = "Paused"
    L['需要团员的BGForge版本高于v2.0.0，否则团员无法看见拍卖框。'] = "All raid members must run BGForge v2.0.0 or newer to view the auction frame."
    L["正在核对"] = "Verifying..."
    ...
    L['团长的BGForge版本高于v2.0.7时才能收到你的请求。'] = "The raid leader needs BGForge v2.0.7+ to receive your request."
    L['团长的BGForge版本高于%s时才能收到你的请求。'] = "The raid leader needs BGForge %s+ to receive your request."
...
do -- Mail history
    ...
    -- 批量邮寄工资 (SendMail) 恢复：BGForge 裁剪时删除了该模块的本地化，2026-08-25 从原版 BiaoGe 补回缺失 key
    ...
    L["提示：点击角色名称可查看装备、背包、专业与资源"] = "Tip: Click a character name to view gear, bags, professions, and resources"
    L["提示：点击角色名称可查看装备、背包、专业与资源、进度"] = "Tip: Click a character name to view gear, bags, professions, resources, and progress"
    L["点击角色名称可查看装备、背包、专业、资源与进度"] = "Click a character name to view gear, bags, professions, resources, and progress"
    ...
    L["专业制造"] = "Profession Crafting"
    L["制造 CD"] = "Crafting CD"
    L["诺森德炼金研究"] = "Northrend Alchemy Research"
    L["炼金转化"] = "Alchemy Transmute"
    L["诺森德铭文研究"] = "Northrend Inscription Research"
    L["小型铭文研究"] = "Minor Inscription Research"
    L["闪亮的玻璃"] = "Brilliant Glass"
    L["尚未扫描以下专业："] = "The following professions have not been scanned:"
    L["如何记录"] = "How to record"
    L["登录该角色后，打开一次上述专业的制造窗口。"] = "Log in to this character and open each profession window listed above once."
    L["首次扫描完成后会自动保存，以后无需重复打开。"] = "The first scan is saved automatically; you do not need to reopen it every time."
    L["可制造"] = "Available"
    L["专业与资源"] = "Professions & Resources"
    L["每日事项"] = "Daily Tasks"
    L["专业轨道"] = "Profession Tracks"
    L["珠宝日常"] = "Jewelcrafting Daily"
    L["烹饪日常"] = "Cooking Daily"
    L["钓鱼日常"] = "Fishing Daily"
    L["每日重置"] = "Daily reset"
    L["已完成"] = "Complete"
    L["未完成"] = "Incomplete"
    L["不适用"] = "Not applicable"
    L["未学习珠宝加工"] = "Jewelcrafting not learned"
    L["辅助技能"] = "Secondary Skills"
    L["资格尚未记录"] = "Eligibility not recorded"
    L["尚未学习"] = "Not learned"
    L["未学习"] = "Not learned"
    L["未学习%s"] = "%s not learned"
    L["暂不可做"] = "Not yet eligible"
    L["技能需达到 %d"] = "Skill level %d required"
    L["角色等级需达到 %d"] = "Character level %d required"
    L["冷却中"] = "Cooling down"
    L["未扫描"] = "Not scanned"
    L["本专业无长 CD 项"] = "No long-cooldown crafts for this profession"
    L["打开%s窗口刷新"] = "Open %s to refresh"
    L["资源总览"] = "Resource Overview"
    L["传说升级材料"] = "Legendary Upgrade Materials"
    L["传说级升级材料"] = "Legendary Upgrade Materials"
    L["资源更新"] = "Resources updated"
    L["专业尚未记录"] = "Professions not recorded yet"
    L["本周进度"] = "Weekly Progress"
    L["首领进度"] = "Boss Progress"
    L["暂无首领数据"] = "Boss data is not available"
    L["未锁定"] = "Not locked"
    L["未开始"] = "Not started"
    L["进度更新"] = "Progress updated"
    L["进度尚未记录"] = "Progress not recorded yet"
    L["副本 %d/%d · 周常 %d/%d"] = "Raids %d/%d · Weeklies %d/%d"
    L["副本 %d/%d"] = "Raids %d/%d"
    L["统一重置 %s"] = "Unified reset %s"
    ...
    L["个人心愿单"] = "Personal Wishlist"
    L["选择想要的装备；实际掉落后会提醒，并在拍卖时保持展开。"] = "Choose gear you want. Its actual drop triggers an alert and stays expanded during auctions."
    L["按职业套装与首领掉落建立心愿；实际掉落会提醒，拍卖时保持展开。"] = "Choose class-set tokens and boss drops. Drops trigger alerts and stay expanded during auctions."
    L["本阶段心愿（%d）"] = "Phase Wishlist (%d)"
    L["当前阶段尚无心愿；可以从职业套装或首领掉落中选择。"] = "No wishes for this phase yet. Choose from class sets or boss drops."
    L["职业套装"] = "Class Sets"
    L["同一兑换物只需选择一次，任意首领掉落或进入拍卖都会提醒。"] = "Select a token once; any boss drop or auction for it will trigger the wishlist."
    L["适合当前职业"] = "For Your Class"
    L["%d 件套装兑换物"] = "%d Set Tokens"
    L["套装兑换物"] = "Set Token"
    L["%s · 来自 %d 个首领"] = "%s · %d Boss Sources"
    L["来源：%s"] = "Sources: %s"
    L["点击设为心愿"] = "Click to add this wish"
    L["再次点击取消心愿"] = "Click again to remove this wish"
    L["物品等级 %s"] = "Item Level %s"
    L["%s，%s"] = "%s, %s"
    L["首领掉落"] = "Boss Drops"
    L["%d号 · %s"] = "No. %d · %s"
    L["职业套装兑换物已归入上方；这里仅展示各首领的其他实际掉落。"] = "Class-set tokens are grouped above; only each boss's other actual drops appear here."
    L["%d 件散件 · %d 件套装兑换物 · %d 件已选择"] = "%d Direct Drops · %d Set Tokens · %d Selected"
    L["此首领的可选物品均已归入上方职业套装模块。"] = "All selectable drops from this boss are grouped in Class Sets above."
    L["清空当前副本"] = "Clear Current Raid"
    L["确定清空当前副本的全部心愿？"] = "Clear every wish for the current raid?"
    L["已清空%s的心愿。"] = "Cleared the wishlist for %s."
    L["点击移除这件心愿装备"] = "Click to remove this wishlist item"
    L["点击加入个人心愿单"] = "Click to add to your personal wishlist"
    L["我的心愿（%d）"] = "My Wishlist (%d)"
    L["暂无心愿，请从下方的BOSS掉落中选择。"] = "No wishes yet. Choose from the boss drops below."
    L["选择BOSS掉落"] = "Choose Boss Drops"
    L["已移除心愿：%s"] = "Removed wish: %s"
    L["已更新心愿：%s"] = "Updated wish: %s"
    L["已加入心愿：%s"] = "Added wish: %s"
    L["只能选择Titan团本BOSS正常掉落的装备"] = "Only normal Titan raid boss drops can be added"
    L["首领"] = "Boss"
    L["测试掉落（临时）"] = "Test Drop (Temporary)"
    L["优先模拟当前副本最近选择的心愿；没有记录时使用第一件。只显示提醒，不会删除或修改心愿。"] = "Uses the most recently selected wish in this raid, or the first one if none was selected this session. It only shows the alert and does not change the wishlist."
    L["请先为当前副本添加一件心愿装备"] = "Add a wishlist item for the current raid first"
    L["测试拍卖（临时）"] = "Test Auction (Temporary)"
    L["使用同一件心愿装备创建纯本地拍卖预览；不会发消息、开始拍卖或记录结果。"] = "Creates a local auction preview for the same wishlist item. It does not send messages, start an auction, or record a result."
    L["拍卖预览尚未初始化，请重新载入界面"] = "The auction preview is not initialized; reload the UI"
    L["心愿拍卖预览"] = "Wishlist Auction Preview"
    L["预览"] = "Preview"
