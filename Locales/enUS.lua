...
do -- Mail history
    ...
    L["点击左侧套装兑换物或中间首领掉落加入心愿；再次点击即可移除。"] = "Click a set token on the left or a boss drop in the middle to add it; click again to remove it."
    L["职业套装"] = "Class Sets"
    ...
    L["%s，%s"] = "%s, %s"
    L["首领掉落"] = "Boss Drops"
    L["搜索装备名称"] = "Search item name"
    L["清除搜索"] = "Clear search"
    L["搜索结果（%d）"] = "Search Results (%d)"
    L["没有找到匹配的首领掉落。"] = "No matching boss drops."
    L["%d号 · %s"] = "No. %d · %s"
