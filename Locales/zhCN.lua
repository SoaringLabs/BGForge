...
do --简体说明书
    ns.instructionsText = {
        ...
        " ",
        "|cff00BFFF操作指令：|r",
        "|cffFFFFFF-打开命令：|r/bgf、/bglite 或 /gbg，也可在游戏设置中绑定按键。",
...
do
    ...
    L["BGForge插件提醒：由于暴雪对插件UI数量的限制，本插件无法在硬核服务器使用，请你自行禁用。"] = true
    L["显示悬浮框"] = true
    L["悬浮框缩放"] = true
    L["调整悬浮框UI的大小。"] = true
    L["悬浮框层级"] = true
    L["|cff808080流拍价："] = true
    L["也有可能是你的WCL插件缺少本服务器数据包。鼠标指向一个玩家时，如果不显示WCL数据，说明就是上述问题。此问题与BGForge插件无关。"] = true
    L["保存"] = true
    L["分享"] = true
    L["导出"] = true
    L["应用"] = true
    ...
    L["输入框字号"] = true
    L["BGForge插件大量使用输入框，该选项可以修改其字体大小。"] = true
    L["输入框字号（需重载）"] = true
    L["清空表格时的金币："] = true
    L["开启该模块需要重载游戏。\n现在立刻重载吗？"] = true
    L["+职业"] = true
    ...
    L["已完成橙片任务。"] = true
    L["未知橙片数量|cffFFD100（该玩家可能未安装BGForge插件，或者BGForge插件版本太低）|r"] = true
    L["|cff00ff00已完成任务|r"] = true
    L["|cffff0000未知数量|r"] = true
    L["|cffff0000(未知数量)|r"] = true
    L["|cffff0000未指定|r"] = true
    L["重置配置"] = true
    L["确认重置BGForge插件的所有配置文件？包括心愿清单、历史表格、角色总览、设置选项等等全部都会被重置。"] = true
    ...
    L["取消勾选则不会保存表格。"] = true
    L["不显示低于该装等的角色："] = true
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGForge插件，可以不用安装该WA。"] = true
    L["v2.5：拍卖金额超过1万时会进行缩写。ALT+点击折叠时，会对全部拍卖窗口折叠"] = true
    L["历史最大金币"] = true
    L["工程技能点"] = true
    L["获得小宠物数量"] = true
    L["<BGForge> 已自动清空表格< %s >，分钱人数已改为%s人。"] = true
    L["你的BGForge插件存在问题，请删除本地插件再重新安装一次（需要大退）。"] = true
    L["团员名单"] = true
    L["< 交易记账成功 >|r\n装备：%s\n买家：%s\n金额：%s%d|rg%s\nBoss：%s%s|r"] = true
    ...
    L["交流群"] = true
    L["BGForge插件未来的更新计划共享在在线文档。"] = true
    ...
    L["你可在插件设置-BGForge-其他功能-查询记录里关闭这个功能。"] = true
    L["关闭名单"] = true
    ...
    L["进入DD语音"] = true
    L["进入团长的DD语音房间"] = true
    L["需要你在后台已打开网易DD，否则进入失败。\n\n|cff808080你可在插件设置-BGForge-其他功能-密语模板里关闭这个功能。|r"] = true
    L["罚款"] = true
    L["点击记入杂项"] = true
    L["YY："] = true
    L["评价："] = true
    ...
    L["把对方账单的金额覆盖我当前表格的金额。如果对方是BGForge插件的账单，则也会复制其买家。"] = true
    ...
    L["已删除<%s>的举报记录。"] = true
    L["删除举报记录"] = true
    L["删除该名玩家在BGForge插件里的全部举报记录。\n\n|cff808080你可在插件设置-BGForge-其他功能里关闭这个功能。|r"] = true
    L["遭劫货物"] = true
    ...
    L["你可在插件设置-BGForge-其他功能里关闭这个功能。"] = true
    L["查询记录"] = true
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00BFFF关注|r和|cff00FF00心愿|r。"] = true
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00BFFF关注|r。"] = true
    L["|cff00BFFF<BGForge>|r 已自动取消%s的|cff00FF00心愿|r。"] = true
    L["全阶段"] = true
    L["小团本%s"] = true
    L["当前没有满级角色"] = true
    L["恶意骚扰"] = true
    ...
    L["该目标类型不是玩家。"] = true
    L["你没有目标。"] = true
    L["集结号增强|cff808080（该功能由BGForge插件提供）|r"] = true
    L["不自动退出集结号频道"] = true
    ...
    L["|cffFFFFFF安装WA：|r此WA是团员端，用于接收团长发出的拍卖消息，没安装的团员显示不了拍卖UI。请团长安装该WA字符串后发给团员安装。如果团员已经安装了BGForge插件并且版本在1.7.0或以上，可以不用安装该WA。"] = true
    ...
    L["<BGForge> 已自动清空表格< %s >，分钱人数已改为%s人。原表格数据已保存至历史表格1。"] = true
    L["撤回清空"] = true
    L["<BGForge> 已撤回清空，还原了表格数据，并删除了历史表格1。"] = true
    L["只能撤回一次。"] = true
    L["没有欠款"] = true
    L["当前装备自动记录位置："] = true
    L["BOSS战开始"] = true
    ...
    L["对账"] = true
    L["< 对账 >"] = true
    L["当团队有人通报BGForge/RaidLedger/大脚的账单，你可以选择该账单，来对账"] = true
    ...
    L["含有%s属性的装备"] = true
    L["如果你想关闭该功能，可在插件设置-BGForge-角色总览里关闭"] = true
    L["SHIFT+点击："] = true
    L["< 我是教程 >"] = true
    ...
    L["< 查询大众评价 >"] = true
    L["1、对BGForgeYY频道的在线玩家发出该YY的请求"] = true
    ...
    L["远程职责"] = true
    L["该副本没有团本攻略"] = true
    L["< BGForge > 你的当前版本%s已过期，请更新插件。"] = true
    ...
    L["已保存至历史表格1"] = true
    L["历史表格保留时长"] = true
    L["当前表格为空，未保存历史记录。"] = true
    L["历史表格保存失败。"] = true
    L["已保存至历史表格，当前表格不会被清空。"] = true
    L["当前表格与最近一条历史记录相同，未重复保存。"] = true
    L["确定应用历史表格？\n当前表格及相关拍卖、交易和团队快照数据将被替换或清空。"] = true
    L["保存当前表格的本地副本，不会清空当前表格，也不会分享给其他玩家。"] = true
    L["当你进入一个新CD团本时，表格会自动清空，原表格数据默认保存至历史表格。"] = true
    L["新CD触发自动清空时，先把当前表格保存至本地历史表格；保存失败则不会清空。"] = true
    L["历史表格保存失败，已取消自动清空，当前表格仍然保留。"] = true
    L["已自动清空表格< %s >，分钱人数已改为%s人，原表格已保存至历史表格。"] = true
    L["已自动清空表格< %s >，分钱人数已改为%s人；当前表格与最近历史记录相同，未重复保存。"] = true
    L["设置"] = true
    L["当前难度:"] = true
    L["切换副本难度"] = true
    ...
    L["<UI缩放>"] = true
    L["<UI透明度>"] = true
    L["< BGForge > 版本过期提醒，最新版本是：%s，你的当前版本是：%s"] = true
    L["星星"] = true
    L["BGForge金团表格"] = true
    L["显示/关闭表格"] = true
    L["对比的账单："] = true
...
do
    ...
    L['不在团队里。'] = true
    L['表格没有历史成员名单。'] = true
    L['当前团队名单暂不可用，无法判断是否换团，本次不会自动清空。'] = true
    L['表格的历史成员名单无效，判断为现在是新团队。'] = true
    ...
    L["第二代拍卖"] = true
    L["已暂停"] = true
    L['需要团员的BGForge版本高于v2.0.0，否则团员无法看见拍卖框。'] = true
    L["正在核对"] = true
    L["忽略战网绑定"] = true
    L["忽略战网绑定的装备"] = true
    ...
    L['向团长申请重拍'] = true
    L['提醒团长拍卖'] = true
    L['团长的BGForge版本高于v2.0.7时才能收到你的请求。'] = true
    ...
    L["忽略帝王丝绸（需重载）"] = true
    L["已开始自动出价：%s %s。"] = true
    L['团长的BGForge版本高于%s时才能收到你的请求。'] = true
    L["拍重"] = true
    L["以下装备可能存在重复拍卖："] = true
end
...
do
    ...
    -- 本机多角色团本锁定
    L["尚未收到当前角色的团本锁定数据。"] = true
    L["未检测到团本锁定"] = true
    L["已击杀"] = true
    L["重置时间"] = true
    L["正在刷新当前角色的团本锁定…"] = true
    L["刷新时间：%s"] = true
    L["打开/关闭团本CD总览"] = true
    L["所有角色团本锁定总览"] = true
    L["< 角色团本CD总览 >"] = true
    L["汇总当前服务器下已在本机记录的角色本周团本进度"] = true
    L["角色列表"] = true
    L["%d个角色"] = true
    L["查看团本CD"] = true
    L["全角色总览"] = true
    ...
    L["尚未扫描以下专业："] = true
    L["如何记录"] = true
    L["登录该角色后，打开一次上述专业的制造窗口。"] = true
    L["首次扫描完成后会自动保存，以后无需重复打开。"] = true
    L["可制造"] = true
    L["已记录角色（%d）"] = true
    L["已记录角色（%d，隐藏%d）"] = true
    L["暂无已记录角色"] = true
    ...
    L["资源最后记录：%s"] = true
    L["资源尚未记录"] = true
    L["不适合该方案的装备会被置灰。"] = true
    L["再次点击可关闭装备过滤。"] = true
    L["点击启用该装备过滤方案。"] = true
    L["战网账号绑定装备始终保持高亮。"] = true
    L["拍卖版本"] = true
    L["仅团长可见并切换。需要暂停/恢复拍卖等功能时，请选择第二代拍卖"] = true
    L["第二代拍卖新增"] = true
    L["暂停 / 恢复拍卖"] = true
    L["自定义出价后的倒计时重置阈值"] = true
    L["第一代固定 20 秒 · 第二代最低可设 10 秒"] = true
    L["团队兼容检测"] = true
    L["名团员支持第二代拍卖"] = true
    L["当有团员不支持时，建议使用第一代拍卖"] = true
    L["需团员使用基于 BGLite 的版本"] = true
    L["个人心愿单"] = true
    L["选择想要的装备；实际掉落后会提醒，并在拍卖时保持展开。"] = true
    L["按职业套装与首领掉落建立心愿；实际掉落会提醒，拍卖时保持展开。"] = true
    L["本阶段心愿（%d）"] = true
    L["当前阶段尚无心愿；可以从职业套装或首领掉落中选择。"] = true
    L["职业套装"] = true
    L["同一兑换物只需选择一次，任意首领掉落或进入拍卖都会提醒。"] = true
    L["适合当前职业"] = true
    L["%d 件套装兑换物"] = true
    L["套装兑换物"] = true
    L["%s · 来自 %d 个首领"] = true
    ...
    L["首领掉落"] = true
    L["%d号 · %s"] = true
    L["职业套装兑换物已归入上方；这里仅展示各首领的其他实际掉落。"] = true
    L["%d 件散件 · %d 件套装兑换物 · %d 件已选择"] = true
    L["此首领的可选物品均已归入上方职业套装模块。"] = true
    L["清空当前副本"] = true
    L["确定清空当前副本的全部心愿？"] = true
    L["已清空%s的心愿。"] = true
    L["点击移除这件心愿装备"] = true
    L["点击加入个人心愿单"] = true
    L["我的心愿（%d）"] = true
    L["暂无心愿，请从下方的BOSS掉落中选择。"] = true
    L["选择BOSS掉落"] = true
    L["已移除心愿：%s"] = true
    L["已更新心愿：%s"] = true
    L["已加入心愿：%s"] = true
    L["只能选择Titan团本BOSS正常掉落的装备"] = true
    L["首领"] = true
    L["测试掉落（临时）"] = true
    L["优先模拟当前副本最近选择的心愿；没有记录时使用第一件。只显示提醒，不会删除或修改心愿。"] = true
    L["请先为当前副本添加一件心愿装备"] = true
    L["测试拍卖（临时）"] = true
    L["使用同一件心愿装备创建纯本地拍卖预览；不会发消息、开始拍卖或记录结果。"] = true
    L["拍卖预览尚未初始化，请重新载入界面"] = true
    L["心愿拍卖预览"] = true
    L["预览"] = true
