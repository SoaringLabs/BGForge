...
do --简体说明书
    ns.instructionsText = {
        ...
        "支持常规 BiaoGe 拍卖协议，可使用标准拍卖协议的协作方式。",
...
do
    ...
    L["检测到 %s 与 BGForge 同时启用。它们会争用相同的全局变量、界面对象和存档变量，可能导致界面错乱、功能失效或账本数据混乱。建议禁用冲突插件并立即重载界面。"] = true
    L["暂时禁用 %s 并重载"] = true
    L["暂时禁用冲突插件并重载"] = true
    L["暂不处理"] = true
    L["显示悬浮框"] = true
...
do
    ...
    L["查看团本CD"] = true
    L["全角色总览"] = true
    L["提示：点击角色名称可查看装备和背包"] = true
    L["提示：点击角色名称可查看装备、背包、专业与资源"] = true
    L["提示：点击角色名称可查看装备、背包、专业与资源、进度"] = true
    L["点击角色名称可查看装备、背包、专业、资源与进度"] = true
    L["CD展示设置"] = true
    L["勾选要展示的副本模块"] = true
