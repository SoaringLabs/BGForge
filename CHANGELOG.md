...
- 装备页增加选中物品详情，背包增加名称搜索、分类筛选与滚动网格。

### 调整

- 角色详情采用统一角色列表、头像页头和五页导航；专业与资源改为每日事项、专业与资源明细的双栏布局。
...
- 进度页优先展示未开始副本，选中副本后在右侧查看首领记录。本周有首领击杀即计为已完成，击杀数量独立保留，周常仍按任务记录判断。
...
- 修复未学习烹饪或钓鱼的角色仍被提示对应日常“未完成”的问题；“专业与资源”页会改为显示不适用及具体原因。
