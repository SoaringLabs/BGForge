...
BG.Init(function()
    ...
    local function Addon_OnEnter(self, _, tooltip)
        ...
        --[[         if self.isAuciton then
            tooltip:AddLine(L["需全团安装%s，没安装的人将会看不到拍卖窗口。"]:format(BG.IsRetail and "BGForge插件" or L["拍卖WA"]), 0.5, 0.5, 0.5, true)
