...
BG.Init2(function()
    ...
    function BG.autoLootButton:OnEnter()
        ...
        GameTooltip:AddLine(BG.STC_dis(L["你可在插件设置-BGForge-其他功能里关闭这个功能。"]), 0.5, 0.5, 0.5, true)
        ...
        local function CreateRaidButton(i)
            ...
            f:SetScript("OnEnter", function()
                ...
                if f.tips == "finish" then
                    ...
                    GameTooltip:AddLine(L["未知橙片数量|cffFFD100（该玩家可能未安装BGForge插件，或者BGForge插件版本太低）|r"], 1, 0, 0, true)
                end
                GameTooltip:Show()
            end)
